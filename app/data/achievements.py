# filepath: something-something-portfolio-app/app/data/achievements.py
...
def get_achievement_slides():
    """
    Centralized achievement carousel data.
    Replaces repetitive carousel creation like card_factory.py pattern.
    """
    return [
        generate_carousel_slide(
            ...
            sources1=[
                generate_source_link(
                    "https://www.linkedin.com/feed/update/urn:li:activity:7285343139874140160?updateEntityUrn=urn%3Ali%3Afs_updateV2%3A%28urn%3Ali%3Aactivity%3A7285343139874140160%2CFEED_DETAIL%2CEMPTY%2CDEFAULT%2Cfalse%29",
        ...
        generate_carousel_slide(
            ...
            alt="Beat cancer bell ringing ceremony",
            ...
            sources2=[
                ...
                generate_source_link(
                    "https://www.bloodcancers.ca/sites/default/files/2023-02/LSC22103_LLS1001E_AML%20Brochure_E_m4.pdf",
                    "Leukemia & Lymphoma Society"
                ),
                generate_source_link(
                    "https://bmccancer.biomedcentral.com/articles/10.1186/s12885-023-10612-z",
                    "BioMed Central"
                )
            ]
        ),
        generate_carousel_slide(
            ...
            alt="Alan completing 5K run at Donkey Sanctuary",
        ...
        generate_carousel_slide(
            ...
            alt="York University ACE program logo",
            ...
            sources1=[
                generate_source_link(
                    "https://news.yorku.ca/2005/05/30/york-u-honours-2005-ace-graduates-with-5000-scholarships/",
