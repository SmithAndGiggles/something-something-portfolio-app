...
def get_achievement_slides():
    ...
    return [
        _create_slide(
            ...
            sources1=_create_source_links([(linkedin_post_url, "Full LinkedIn post here")])
        ),
        _create_slide(
            ...
            sources2=_create_source_links([COMMON_SOURCES['alberta_health'], COMMON_SOURCES['leukemia_society'], COMMON_SOURCES['biomedcentral']])
        ),
        _create_slide(
