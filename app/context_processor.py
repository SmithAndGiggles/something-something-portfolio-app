...
def inject_nav_links():
    ...
    nav_links = [
        {
            "href": url_for("routes.education"),
            "icon": "fas fa-graduation-cap",
            "label": "EDUCATION",
        },
        {
            "href": url_for("routes.certifications"),
            "icon": "fas fa-certificate",
            "label": "CERTIFICATIONS",
        },
        {
            "href": url_for("routes.achievements"),
            "icon": "fas fa-trophy",
            "label": "ACHIEVEMENTS",
        },
        {
            "href": url_for("routes.techstack"),
    ...
    return dict(
        nav_links=nav_links,
        app_name=current_app.config.get("APP_NAME", "me2u Portfolio"),
    )
    ...
    footer_links = [
        {
            ...
            "logo": url_for("static", filename="images/logos/logo-linkedin.png"),
            "label": "LinkedIn",
        },
        {
            "href": "https://github.com/SmithAndGiggles",
            "logo": url_for("static", filename="images/logos/logo-github-dark.png"),
            "label": "GitHub",
        },
    ]
